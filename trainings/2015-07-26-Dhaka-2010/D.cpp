...
int can_go(int nx, int ny, int dir) {
    ...
    if (dir == 1) {
        nx += dx[dir];
        ny += dy[dir];
        if (obstacle[nx][ny] == 1 || obstacle[nx][ny + 1] == 1) {
            return 0;
        }
        return 1;
    }
    if (dir == 2) {
        nx += dx[dir];
        ny += dy[dir];
        if (obstacle[nx + 1][ny] == 1 || obstacle[nx + 1][ny + 1] == 1) {
            return 0;
        }
        return 1;
    }
    if (dir == 3) {
        nx += dx[dir];
        ny += dy[dir];
        if (obstacle[nx][ny] == 1 || obstacle[nx + 1][ny] == 1) {
            return 0;
        }
        return 1;
    }
    if (dir == 4) {
        nx += dx[dir];
        ny += dy[dir];
        if (obstacle[nx][ny + 1] == 1 || obstacle[nx + 1][ny + 1] == 1) {
            return 0;
        }
        return 1;
    }
